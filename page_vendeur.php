		...
		<div class="row"> 
			<div class="list" id="tab">
				<form  method="post" action="vendeur.php">
					<table>
						<p><h2 class="ft_title">Ajouter un article à vendre</h2></p>
						<tr>
						...
						<tr>
							...
							<td id="select2">
								<select name="cho2[]"> 
									...
									<option value="Sport extérieur">Sport extérieur</option>
						...
						<tr>
							<td>(* optionnel)</td>
							<td><input type="submit" class="button" value="Mettre en vente" id="button2" name="button2"/></td>
						</tr>
					</table>
				</form>		
			</div>         
			<div class="blocvendeur">   
				<table  class="bandeaubloc">
					<tr><td><h2 class="ft_title">Vos articles en vente</h2></td></tr>
					<tr class="corpsbloc">
						<td>
							<?php
