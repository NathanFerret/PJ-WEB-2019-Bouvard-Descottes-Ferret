        ...
        if($valeur=='Musique'){foreach($_POST['cho3'] as $selectValue){}}
         ...
         if ($db_found) {
          if($Prix>0 ){
           ...
           $sql = "INSERT INTO item (nomitem,description,prixunitaire,video,categorie,sscategorie,image,couleur,taille,genre,pseudo) VALUES('$nom','$Description','$Prix','$urlv','$valeur','$selectValue','$url','$couleur','$taille','$genre','$sess')";
